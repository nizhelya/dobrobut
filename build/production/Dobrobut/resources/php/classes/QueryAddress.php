...
//print($_sql);  
		 break;
		   case "TabHouseResidents":
			  $_sql= 'SELECT t1.* FROM YIS.APPARTMENT as t1  WHERE t1.`house_id`='.$this->house_id.' order by SUBSTRING_INDEX(t1.`address,'/',1) '; 
//print($_sql);  
		 break;
  ...
  // print_r($this->sql);
	...
	case "otkat_oplata_port":
	  ...
	  case "nachislenie_podogrev_house":
			      $this->sql='CALL YISGRAND.nachislenie_podogrev_house("'.$this->house_id.'",@success,@msg)';
			  //  print_r($this->sql); 
