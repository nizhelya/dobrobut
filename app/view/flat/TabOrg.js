...
Ext.define('Dobrobut.view.flat.TabOrg', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.taborg',

    requires: [
        'Dobrobut.view.flat.TabOrgViewModel',
        'Ext.form.Panel',
    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    text: 'Рассылка информационного листка по Email'
                },
                {
                    xtype: 'button',
                    handler: function(button, e) {
                    ...
                    text: 'Распечатка  информации по всем ОСМД '
                }
            ]
        }
    ],
